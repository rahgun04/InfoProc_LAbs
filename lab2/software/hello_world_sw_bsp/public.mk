...
# setting SOPC_SYSID_BASE_ADDRESS is 0x210a0
SOPC_SYSID_FLAG += --sidp=0x210a0
ELF_PATCH_FLAG  += --sidp 0x210a0

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1706616442
SOPC_SYSID_FLAG += --timestamp=1706616442
ELF_PATCH_FLAG  += --timestamp 1706616442
