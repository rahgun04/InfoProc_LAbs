...
module unsaved_mm_interconnect_0 (
	...
	wire  [13:0] cmd_mux_003_src_channel;                                                   // cmd_mux_003:src_channel -> onchip_memory_s1_agent:cp_channel
	...
	wire  [13:0] cmd_mux_004_src_channel;                                                   // cmd_mux_004:src_channel -> button_s1_agent:cp_channel
	...
	wire  [96:0] hex_0_s1_agent_rf_source_data;                                             // hex_0_s1_agent:rf_source_data -> hex_0_s1_agent_rsp_fifo:in_data
	...
	wire  [96:0] hex_0_s1_agent_rsp_fifo_out_data;                                          // hex_0_s1_agent_rsp_fifo:out_data -> hex_0_s1_agent:rf_sink_data
	...
	wire  [95:0] cmd_mux_008_src_data;                                                      // cmd_mux_008:src_data -> hex_0_s1_agent:cp_data
	wire         cmd_mux_008_src_ready;                                                     // hex_0_s1_agent:cp_ready -> cmd_mux_008:src_ready
	wire  [13:0] cmd_mux_008_src_channel;                                                   // cmd_mux_008:src_channel -> hex_0_s1_agent:cp_channel
	...
	wire  [96:0] hex_1_s1_agent_rf_source_data;                                             // hex_1_s1_agent:rf_source_data -> hex_1_s1_agent_rsp_fifo:in_data
	...
	wire  [96:0] hex_1_s1_agent_rsp_fifo_out_data;                                          // hex_1_s1_agent_rsp_fifo:out_data -> hex_1_s1_agent:rf_sink_data
	...
	wire  [95:0] cmd_mux_009_src_data;                                                      // cmd_mux_009:src_data -> hex_1_s1_agent:cp_data
	wire         cmd_mux_009_src_ready;                                                     // hex_1_s1_agent:cp_ready -> cmd_mux_009:src_ready
	wire  [13:0] cmd_mux_009_src_channel;                                                   // cmd_mux_009:src_channel -> hex_1_s1_agent:cp_channel
	...
	wire  [96:0] hex_2_s1_agent_rf_source_data;                                             // hex_2_s1_agent:rf_source_data -> hex_2_s1_agent_rsp_fifo:in_data
	...
	wire  [96:0] hex_2_s1_agent_rsp_fifo_out_data;                                          // hex_2_s1_agent_rsp_fifo:out_data -> hex_2_s1_agent:rf_sink_data
	...
	wire  [95:0] cmd_mux_010_src_data;                                                      // cmd_mux_010:src_data -> hex_2_s1_agent:cp_data
	wire         cmd_mux_010_src_ready;                                                     // hex_2_s1_agent:cp_ready -> cmd_mux_010:src_ready
	wire  [13:0] cmd_mux_010_src_channel;                                                   // cmd_mux_010:src_channel -> hex_2_s1_agent:cp_channel
	...
	wire  [96:0] hex_3_s1_agent_rf_source_data;                                             // hex_3_s1_agent:rf_source_data -> hex_3_s1_agent_rsp_fifo:in_data
	...
	wire  [96:0] hex_3_s1_agent_rsp_fifo_out_data;                                          // hex_3_s1_agent_rsp_fifo:out_data -> hex_3_s1_agent:rf_sink_data
	...
	wire  [95:0] cmd_mux_011_src_data;                                                      // cmd_mux_011:src_data -> hex_3_s1_agent:cp_data
	wire         cmd_mux_011_src_ready;                                                     // hex_3_s1_agent:cp_ready -> cmd_mux_011:src_ready
	wire  [13:0] cmd_mux_011_src_channel;                                                   // cmd_mux_011:src_channel -> hex_3_s1_agent:cp_channel
	...
	wire  [96:0] hex_4_s1_agent_rf_source_data;                                             // hex_4_s1_agent:rf_source_data -> hex_4_s1_agent_rsp_fifo:in_data
	...
	wire  [96:0] hex_4_s1_agent_rsp_fifo_out_data;                                          // hex_4_s1_agent_rsp_fifo:out_data -> hex_4_s1_agent:rf_sink_data
	...
	wire  [95:0] cmd_mux_012_src_data;                                                      // cmd_mux_012:src_data -> hex_4_s1_agent:cp_data
	wire         cmd_mux_012_src_ready;                                                     // hex_4_s1_agent:cp_ready -> cmd_mux_012:src_ready
	wire  [13:0] cmd_mux_012_src_channel;                                                   // cmd_mux_012:src_channel -> hex_4_s1_agent:cp_channel
	...
	wire  [96:0] hex_5_s1_agent_rf_source_data;                                             // hex_5_s1_agent:rf_source_data -> hex_5_s1_agent_rsp_fifo:in_data
	...
	wire  [96:0] hex_5_s1_agent_rsp_fifo_out_data;                                          // hex_5_s1_agent_rsp_fifo:out_data -> hex_5_s1_agent:rf_sink_data
	...
	wire  [95:0] cmd_mux_013_src_data;                                                      // cmd_mux_013:src_data -> hex_5_s1_agent:cp_data
	wire         cmd_mux_013_src_ready;                                                     // hex_5_s1_agent:cp_ready -> cmd_mux_013:src_ready
	wire  [13:0] cmd_mux_013_src_channel;                                                   // cmd_mux_013:src_channel -> hex_5_s1_agent:cp_channel
	...
	wire  [95:0] hex_0_s1_agent_rp_data;                                                    // hex_0_s1_agent:rp_data -> router_010:sink_data
	...
	wire  [95:0] hex_1_s1_agent_rp_data;                                                    // hex_1_s1_agent:rp_data -> router_011:sink_data
	...
	wire  [95:0] hex_2_s1_agent_rp_data;                                                    // hex_2_s1_agent:rp_data -> router_012:sink_data
	...
	wire  [95:0] hex_3_s1_agent_rp_data;                                                    // hex_3_s1_agent:rp_data -> router_013:sink_data
	...
	wire  [95:0] hex_4_s1_agent_rp_data;                                                    // hex_4_s1_agent:rp_data -> router_014:sink_data
	...
	wire  [95:0] hex_5_s1_agent_rp_data;                                                    // hex_5_s1_agent:rp_data -> router_015:sink_data
	...
	unsaved_mm_interconnect_0_router_002 router_010 (
	...
	unsaved_mm_interconnect_0_router_002 router_011 (
	...
	unsaved_mm_interconnect_0_router_002 router_012 (
	...
	unsaved_mm_interconnect_0_router_002 router_013 (
	...
	unsaved_mm_interconnect_0_router_002 router_014 (
	...
	unsaved_mm_interconnect_0_router_002 router_015 (
	...
	unsaved_mm_interconnect_0_rsp_demux rsp_demux_012 (
		.clk                (clk_clk_clk),                           //       clk.clk
		.reset              (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	unsaved_mm_interconnect_0_rsp_demux rsp_demux_013 (
		.clk                (clk_clk_clk),                           //       clk.clk
		.reset              (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
